...
export const TOOL_PROFILES: Record<ToolProfile, string[]> = {
  ...
  code_edit: ['file.read', 'file.read_many', 'file.search', 'file.hash', 'file.outline', 'patch.dry_run', 'snapshot.create', 'git.status', 'git.diff', 'build.run', 'local.patch_risk', 'local.context_pack'],
