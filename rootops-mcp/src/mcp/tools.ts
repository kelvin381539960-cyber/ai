export const toolDefinitions = [
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        items: { type: 'array', items: { type: 'object', properties: { path: { type: 'string' }, offset_line: { type: 'number' }, limit_lines: { type: 'number' }, max_bytes: { type: 'number' }, with_line_numbers: { type: 'boolean' } }, required: ['path'] } },
  ...
  },
  {
    ...
    inputSchema: {
      type: 'object',
      properties: {
        path: { type: 'string' }, query: { type: 'string' }, max_results: { type: 'number', default: 50 }, file_glob: { type: 'string' }, regex: { type: 'boolean', default: false }, case_sensitive: { type: 'boolean', default: false }, include_filenames: { type: 'boolean', default: true }, include_contents: { type: 'boolean', default: true }, max_file_bytes: { type: 'number', default: 262144 }, context_before: { type: 'number', default: 0 }, context_after: { type: 'number', default: 0 }, cursor: { type: 'string' }, backend: { type: 'string', enum: ['auto', 'rg', 'native'], default: 'auto' }
      },
      required: ['query']
    }
  },
  ...
  },
  {
    ...
    description: 'Create a snapshot copy of a file before editing.',
    inputSchema: { type: 'object', properties: { path: { type: 'string' }, reason: { type: 'string', default: 'manual' } }, required: ['path'] }
  },
  {
    name: 'patch.dry_run',
    ...
    inputSchema: {
      type: 'object',
      properties: {
        path: { type: 'string' }, expected_hash: { type: 'string' }, old_text: { type: 'string' }, new_text: { type: 'string' }, risk: { type: 'string', enum: ['R0', 'R1', 'R2', 'R3', 'R4'], default: 'R1' }, dry_run_required: { type: 'boolean', default: true }, auto_snapshot: { type: 'boolean', default: true }, with_local_risk: { type: 'boolean', default: false }
      },
  ...
  },
  {
    ...
    inputSchema: { type: 'object', properties: { texts: { type: 'array', items: { type: 'string' } } }, required: ['texts'] }
  },
  {
    name: 'local.rerank',
    description: 'Rerank candidate snippets for a query using the configured local model sidecar.',
    inputSchema: { type: 'object', properties: { query: { type: 'string' }, candidates: { type: 'array', items: { type: 'object', properties: { id: { type: 'string' }, text: { type: 'string' }, metadata: { type: 'object' } }, required: ['id', 'text'] } } }, required: ['query', 'candidates'] }
  },
  {
  ...
  },
  {
    ...
    inputSchema: { type: 'object', properties: { root: { type: 'string' }, query: { type: 'string' }, max_files: { type: 'number', default: 8 }, max_total_bytes: { type: 'number', default: 524288 }, lines_per_file: { type: 'number', default: 120 }, file_glob: { type: 'string' } }, required: ['query'] }
  }
];
